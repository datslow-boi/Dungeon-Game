...
class Inventory_manager:
    ...
    def check_events(self, event):
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_e:
                if self.items:
                    if current_item and isinstance(current_item, items.Consume):
                    ...
                    if current_item and isinstance(current_item, items.Equipment):
            ...
            if event.key == pygame.K_x:
                if current_item:
                    if isinstance(current_item, items.Equipment) and current_item.equipped:
                        current_item.unequip_item(self.game)
                        self.equipped_items.remove(current_item)
    ...
    def draw(self):
        ...
        for i, item in enumerate(self.items):
            color = "white"
            if isinstance(item, items.Equipment) and item.equipped:
                color = "green"
